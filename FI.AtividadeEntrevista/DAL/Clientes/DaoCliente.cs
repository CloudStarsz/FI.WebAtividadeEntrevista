...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("Nome", cliente.Nome.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Sobrenome", cliente.Sobrenome.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Nacionalidade", cliente.Nacionalidade.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("CEP", cliente.CEP.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Estado", cliente.Estado.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Cidade", cliente.Cidade.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Logradouro", cliente.Logradouro.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Email", cliente.Email.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("Telefone", cliente.Telefone.Trim()));
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", cliente.CPF.Trim()));
